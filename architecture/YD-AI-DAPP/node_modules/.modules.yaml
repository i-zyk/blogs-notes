...
hoistedDependencies:
  ...
  '@jest/core@30.0.3(node-notifier@10.0.1)':
    '@jest/core': private
  ...
  '@jest/reporters@30.0.2(node-notifier@10.0.1)':
  ...
  '@mirzazeyrek/node-resemble-js@1.2.1':
    '@mirzazeyrek/node-resemble-js': private
  ...
  jest-circus@30.0.3:
    jest-circus: private
  jest-cli@30.0.3(@types/node@24.0.3)(node-notifier@10.0.1):
    jest-cli: private
  ...
  super-simple-web-server@1.1.4:
    super-simple-web-server: private
...
pendingBuilds: []
prunedAt: Tue, 01 Jul 2025 13:42:29 GMT
publicHoistPattern: []
registries:
